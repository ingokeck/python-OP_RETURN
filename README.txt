...
Changes for dogecoin by Ingo Keck.
...
If using as a library, add 'import op_return_dogecoin' in your Python script file.


TO SEND A DOGECOIN TRANSACTION WITH SOME OP_RETURN METADATA
----------------------------------------------------------

[note: the examples will fail as they use bitcoin addresses. sorry about that.]
